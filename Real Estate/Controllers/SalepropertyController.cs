...
{
    public class SalepropertyController : Controller
    {
        private readonly RealestateContext context;
		private readonly IWebHostEnvironment enviroment;

        public SalepropertyController(RealestateContext context, IWebHostEnvironment enviroment)
        {
		...
		{
			var data = context.SalePropertys.ToList();
			return View(data);
		}
		...
		[HttpPost]
		public IActionResult Create(SaleProperty model)
		{
			try
			{
				if (ModelState.IsValid)
				{
					...
					context.SalePropertys.Add(data);
					context.SaveChanges();
		...
		private string UploadImage(SaleProperty model)
		{
		...
		public IActionResult Delete(int id)
		{
			...
			{
				var data = context.SalePropertys.Where(e => e.Id == id).SingleOrDefault();
				if (data != null)
				{
					...
					context.SalePropertys.Remove(data);
					context.SaveChanges();
		...
		[HttpPost]
		public IActionResult Edit(SaleProperty model)
		{
			try
			{
				if (ModelState.IsValid)
				{
					var data = context.SalePropertys.Where(e => e.Id == model.Id).SingleOrDefault();
					...
					context.SalePropertys.Update(data);
					context.SaveChanges();
